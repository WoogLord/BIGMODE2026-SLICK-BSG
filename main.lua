...
function love.draw()
    ...
    if isDebug then love.graphics.print("ONE NIGHT WINDOW - "..buildVersion.." - build time: 02-07-2026 at 10:30p ET", 5 * gfxScale, currWinDim.h-(gfxScale)-debugFont:getHeight(debugFont)) end
end